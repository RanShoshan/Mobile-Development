...
import static com.ran.MobileDevelopment.R.color.colorBlack;


public class NoXMLConstraintLayout extends AppCompatActivity {
    ConstraintLayout cl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.no_xml_constraintlayout);
